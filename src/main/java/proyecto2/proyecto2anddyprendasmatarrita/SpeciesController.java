...
public class SpeciesController {
    ...
    public void loadData() { //carga datos de species
        listaEspecies.clear();
        listaEspecies.addAll(speciesManager.getAllSpecies());
        speciesTable.setItems(listaEspecies);
    }

    private void loadCollections() {//cargar datos de colecciones 
    ...
    public void showDetails(MahnSpecies species) { //muestra detalles en los textfield sobre la especie seleccionada
        if (species != null) {
    ...
    @FXML
    public void addToDB() { //agrega specie nueva
        try {
